    ...
    <div className="max-w-3xl mx-auto space-y-8">
      ...
      <Card className="space-y-4">
        <h3 className="text-base font-bold text-slate-900 flex items-center gap-2">
          <Wallet className="w-5 h-5 text-blue-600" /> Account Virtual Cash Balances
        </h3>

        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 pt-2">
          <div className="p-4 rounded-xl bg-slate-50 border border-slate-200 space-y-1">
            <span className="text-xs text-slate-500 font-semibold uppercase">US Market Virtual Cash</span>
          ...
          <div className="p-4 rounded-xl bg-slate-50 border border-slate-200 space-y-1">
            <span className="text-xs text-slate-500 font-semibold uppercase">Indian NSE Virtual Cash</span>
            <span className="text-2xl font-bold font-mono text-emerald-600 block">
