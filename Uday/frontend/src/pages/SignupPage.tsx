    ...
    <div className="max-w-md mx-auto py-12">
      <Card className="glass-panel p-8 rounded-2xl space-y-6">
        <div className="text-center space-y-2">
          ...
          <p className="text-xs text-slate-500">Get $100,000 USD + ₹8,000,000 INR virtual cash</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="flex flex-col gap-1.5 w-full">
            <label className="text-xs font-semibold text-slate-500 uppercase tracking-wider">Primary Market Preference</label>
            <select
              value={country}
              onChange={(e) => setCountry(e.target.value as CountryEnum)}
              className="bg-white border border-slate-200 text-slate-900 rounded-lg px-3.5 py-2.5 text-sm outline-none focus:border-blue-500"
            >
