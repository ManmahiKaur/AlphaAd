    ...
    <div className="space-y-24 py-12">
      ...
      <section className="text-center max-w-4xl mx-auto space-y-6">
        ...
        <h1 className="text-4xl sm:text-6xl font-extrabold tracking-tight leading-tight bg-gradient-to-r from-slate-900 via-slate-800 to-slate-600 bg-clip-text text-transparent">
          ...
          <span className="text-blue-600">Virtual Portfolio Advisor</span>
        </h1>

        <p className="text-base sm:text-lg text-slate-600 max-w-2xl mx-auto leading-relaxed">
          Master equity trading across both <strong className="text-slate-900">US (NASDAQ, NYSE)</strong> and <strong className="text-slate-900">Indian (NSE)</strong> markets with real-time technical indicators, virtual cash portfolios, and LangGraph multi-node AI recommendations.
        </p>

        <div className="flex flex-wrap items-center justify-center gap-4 pt-4">
          <Link
            to="/signup"
            className="px-6 py-3.5 rounded-xl bg-blue-600 hover:bg-blue-700 text-white font-extrabold text-sm shadow-xl shadow-blue-500/25 transition-all flex items-center gap-2"
          >
            Start Virtual Trading ($100k Cash) <ArrowRight className="w-4 h-4" />
          </Link>
          <Link
            to="/explore"
            className="px-6 py-3.5 rounded-xl bg-white hover:bg-slate-50 text-slate-700 border border-slate-300 font-bold text-sm transition-all shadow-sm"
          >
            Explore Live Stocks
          </Link>
        </div>
      ...
      <section className="space-y-6">
        <div className="flex items-center justify-between">
          <div>
            <h2 className="text-xl font-bold text-slate-900">Live Market Overview</h2>
            <p className="text-xs text-slate-500">Indian NSE & US Equities quotes preview</p>
          </div>
      ...
      <section className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className="glass-card p-6 rounded-2xl space-y-3">
          ...
          <h3 className="text-base font-bold text-slate-900">9 Math Technical Indicators</h3>
        ...
        <div className="glass-card p-6 rounded-2xl space-y-3">
          ...
          <h3 className="text-base font-bold text-slate-900">LangGraph AI Advisor</h3>
          <p className="text-xs text-slate-600 leading-relaxed">
        ...
        <div className="glass-card p-6 rounded-2xl space-y-3">
          ...
          <h3 className="text-base font-bold text-slate-900">Dual Market Virtual Account</h3>
          <p className="text-xs text-slate-600 leading-relaxed">
