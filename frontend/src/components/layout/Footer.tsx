...
export const Footer: React.FC = () => {
  return (
    <footer className="w-full border-t border-slate-200 bg-white py-10 mt-20">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          ...
          <div>
            <h4 className="text-xs font-bold text-slate-900 uppercase tracking-wider mb-3">Supported Markets</h4>
          ...
          <div>
            <h4 className="text-xs font-bold text-slate-900 uppercase tracking-wider mb-3">Compliance & Disclaimer</h4>
        ...
        <div className="pt-6 border-t border-slate-200 flex flex-col md:flex-row items-center justify-between text-xs text-slate-500">
          ...
          <div className="flex gap-4 mt-2 md:mt-0">
            ...
            <span className="hover:text-blue-600 cursor-pointer">API Docs (/docs)</span>
          </div>
        </div>
      </div>
    </footer>
